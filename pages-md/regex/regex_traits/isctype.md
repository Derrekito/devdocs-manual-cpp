...
Determines whether the character `c` belongs to the character class identified
by `f`, which, in turn, is a value returned by `lookup_classname()` or a bitwise
OR of several such values.
