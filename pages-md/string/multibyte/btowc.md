...
Most multibyte character encodings use single-byte codes to represent the
characters from the ASCII character set. This function may be used to convert
such characters to `wchar_t`.
...
---
*Source: https://en.cppreference.com/w/cpp/string/multibyte/btowc*
