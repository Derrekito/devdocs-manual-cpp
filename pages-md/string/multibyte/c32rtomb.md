...
necessary to store the multibyte character representation of `c32` (including
...
be `​0​`, e.g. when processing the first `char32_t` in
multi-`char32_t`-character sequence (does not occur in UTF-32).
...
---
*Source: https://en.cppreference.com/w/cpp/string/multibyte/c32rtomb*
