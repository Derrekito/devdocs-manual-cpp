...
This function is equivalent to the call `std::mbtowc(nullptr, s, n)`, except
that conversion state of `std::mbtowc` is unaffected.

### Notes

Each call to `mblen` updates the internal global conversion state (a static
...
scans. In any case, multiple threads should not call `mblen` without
synchronization: `std::mbrlen` may be used instead.
...
---
*Source: https://en.cppreference.com/w/cpp/string/multibyte/mblen*
