...
pointed-to `std::mbstate_t` object describes the initial conversion state.

### Notes

Although a zero-initialized `std::mbstate_t` always represents the initial
conversion state, there may be other values of `std::mbstate_t` that also
...
---
*Source: https://en.cppreference.com/w/cpp/string/multibyte/mbsinit*
