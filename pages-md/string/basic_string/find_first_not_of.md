...
size_type find_first_not_of( const basic_string& str,
                             size_type pos = 0 ) const;  // (until C++11)
size_type find_first_not_of( const basic_string& str,
...
size_type find_first_not_of( const CharT* s,
                             size_type pos = 0 ) const;  // (until C++20)
constexpr size_type find_first_not_of( const CharT* s,
                                       size_type pos = 0 ) const;  // (since C++20)
size_type find_first_not_of( CharT ch, size_type pos = 0 ) const;  // (until C++11)
size_type find_first_not_of( CharT ch, size_type pos = 0 ) const noexcept;  // (since C++11) (until C++20)
...
Position of the found character or `std::string::npos` if no such character is
found.
