...
Checks if the given wide character has a graphical representation, i.e. it is
...
Non-zero value if the wide character has a graphical representation character,
zero otherwise.

### Notes

ISO 30112 specifies which Unicode characters are include in POSIX graph
category.
