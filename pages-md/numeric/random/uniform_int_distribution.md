...
Produces random integer values \(\small i\)i, uniformly distributed on the
closed interval \(\small[a, b]\)[a, b], that is, distributed according to the
discrete probability function \({\small P(i|a,b) =}\frac{1}{b - a + 1}\)P(i|a,b)
=
