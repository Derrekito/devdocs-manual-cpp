...
Unqualified function (`sqrt`) is used to perform the computation. If such
function is not available, `std::sqrt` is used due to argument-dependent lookup.
...
---
*Source: https://en.cppreference.com/w/cpp/numeric/valarray/sqrt*
