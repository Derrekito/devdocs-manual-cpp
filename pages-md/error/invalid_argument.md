...
- **(constructor)** — constructs a new `invalid_argument` object with the given
  message (public member function)
- **operator=** — replaces the `invalid_argument` object (public member
  function)
...
Because copying `std::invalid_argument` is not permitted to throw exceptions,
...
dynamic type `std::invalid_argument` then `std::strcmp(what(), other.what()) ==
...
previously published C++ standards.
  ...
  LWG 471 | C++98 | the explanatory strings of `std::invalid_argument`'s copies
