...
At most 2·min(N1, N2) applications of the comparison and corresponding
projections, where `N1 = ranges::distance(first1, last1)` and `N2 =
...
---
*Source: https://en.cppreference.com/w/cpp/algorithm/ranges/lexicographical_compare*
