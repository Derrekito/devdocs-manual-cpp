...
requires std::sortable<I, Comp, Proj>
    I stable_sort( I first, S last, Comp comp = {}, Proj proj = {} );  // (1) (since C++20) (constexpr since C++26)
template< ranges::random_access_range R, class Comp = ranges::less,
          class Proj = std::identity >
requires std::sortable<ranges::iterator_t<R>, Comp, Proj>
ranges::borrowed_iterator_t<R>
    stable_sort( R&& r, Comp comp = {}, Proj proj = {} );  // (2) (since C++20) (constexpr since C++26)
```
...
n` is a valid iterator pointing to an element of the sequence,
...
\(\scriptsize N\cdot\log^2{(N)}\)N·log²(N) comparisons otherwise. Twice as many
projections as the number of comparisons in both cases.
...
memory is available. See also implementation in MSVC STL and libstdc++.
