...
previously published C++ standards.
  ...
  LWG 3590 | C++20 | the `const&` overload additionally required validity of
      copy-assignment | constraints relaxed

### See also

- **base (C++20)** — returns a copy of the underlying (adapted) view (public
  member function of `std::ranges::lazy_split_view<V,Pattern>`)
