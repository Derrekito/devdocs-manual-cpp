...
`true` if this `year_month_day` object represents a valid calendar date, that
is, the stored year, month, and day values are all valid and the stored day
value is within the number of days in the given year and month. Otherwise
`false`.
...
---
*Source: https://en.cppreference.com/w/cpp/chrono/year_month_day/ok*
