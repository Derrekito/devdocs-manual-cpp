...
The program shows the effect of "non-breaking" the cycle of `std::shared_ptr`s.
...
- **(destructor)** — destructs the owned object if no more `shared_ptr`s link to
  it (public member function of `std::shared_ptr<T>`)

---
*Source: https://en.cppreference.com/w/cpp/memory/weak_ptr/%7Eweak_ptr*
