...
that call strict weak orders as their arguments. The key difference between this
concept and `std::strict_weak_order` is that it is applied to the types that
...
---
*Source: https://en.cppreference.com/w/cpp/iterator/indirect_strict_weak_order*
