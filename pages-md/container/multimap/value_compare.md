...
`std::multimap::value_compare` is a function object that compares objects of
type `std::multimap::value_type` (key-value pairs) by comparing of the first
...
- ****(constructor)**** — constructs a new `value_compare` object (protected
  member function)
...
---
*Source: https://en.cppreference.com/w/cpp/container/multimap/value_compare*
