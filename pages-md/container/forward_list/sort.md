...
- **comp** — comparison function object (i.e. an object that satisfies the
  ...
  such that an object of type forward_list<T,Allocator>::const_iterator can be
...
`forward_list`. This function also differs from `std::sort` in that it does not
...
---
*Source: https://en.cppreference.com/w/cpp/container/forward_list/sort*
