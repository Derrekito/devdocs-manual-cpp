...
stack( InputIt, InputIt )
    -> stack<typename std::iterator_traits<InputIt>::value_type>;  // (3) (since C++23)
...
stack( std::from_range_t, R&& )
    -> stack<ranges::range_value_t<R>>;  // (5) (since C++23)
...
---
*Source: https://en.cppreference.com/w/cpp/container/stack/deduction_guides*
