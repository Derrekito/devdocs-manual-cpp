...
stack( std::from_range_t, R&& rg );  // (13) (since C++23)
template< container-compatible-range<T> R, class Alloc >
stack( std::from_range_t, R&& rg, const Alloc& alloc );  // (14) (since C++23)
```
...
7-12) These constructors participate in overload resolution only if
   ...
   library containers that can be used with `stack`).
...
---
*Source: https://en.cppreference.com/w/cpp/container/stack/stack*
