...
reversed `map`. It corresponds to the element preceding the first element of the
non-reversed `map`. This element acts as a placeholder, attempting to access it
...
---
*Source: https://en.cppreference.com/w/cpp/container/map/rend*
