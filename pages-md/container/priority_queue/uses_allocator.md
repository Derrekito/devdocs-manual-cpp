...
for `std::priority_queue`: the container adaptor uses allocator if and only if
...
---
*Source: https://en.cppreference.com/w/cpp/container/priority_queue/uses_allocator*
