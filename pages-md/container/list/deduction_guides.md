...
list( InputIt, InputIt, Alloc = Alloc() )
    -> list<typename std::iterator_traits<InputIt>::value_type, Alloc>;  // (1) (since C++17)
template< ranges::input_range R,
          class Alloc = std::allocator<ranges::range_value_t<R>> >
list( std::from_range_t, R&&, Alloc = Alloc() )
    -> list<ranges::range_value_t<R>, Alloc>;  // (2) (since C++23)
```
...
---
*Source: https://en.cppreference.com/w/cpp/container/list/deduction_guides*
