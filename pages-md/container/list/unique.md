...
element in each group of equal elements is left. Invalidates only the iterators
...
- **p** — binary predicate which returns ​`true` if the elements should be
  ...
  type list<T,Allocator>::const_iterator can be dereferenced and then implicitly
...
previously published C++ standards.
  ...
  LWG 1207 | C++98 | it was unclear whether iterators and/or references will be
      invalidated | only invalidates iterators and references to the removed
      elements
...
---
*Source: https://en.cppreference.com/w/cpp/container/list/unique*
