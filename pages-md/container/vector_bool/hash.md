...
struct hash<std::vector<bool, Allocator>>;  // (since C++11)
```

The template specialization of `std::hash` for `std::vector<bool>` allows users
to obtain hashes of objects of type `std::vector<bool>`.
...
---
*Source: https://en.cppreference.com/w/cpp/container/vector_bool/hash*
