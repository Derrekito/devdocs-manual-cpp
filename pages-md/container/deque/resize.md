...
previously published C++ standards.
  ...
  LWG 1418 | C++98 | the behavior of `resize(size())` was not specified |
      specified
  LWG 2033 | C++11 | 1. elements were removed by using `erase()` 2. `T` was not
      required to be MoveInsertable | 1. uses `pop_back()` 2. required
...
---
*Source: https://en.cppreference.com/w/cpp/container/deque/resize*
