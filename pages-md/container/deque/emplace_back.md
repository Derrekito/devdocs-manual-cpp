...
to a `std::deque`. It demonstrates how `emplace_back` forwards parameters to the
`President` constructor and shows how using `emplace_back` avoids the extra copy
or move operation required when using `push_back`.
...
---
*Source: https://en.cppreference.com/w/cpp/container/deque/emplace_back*
