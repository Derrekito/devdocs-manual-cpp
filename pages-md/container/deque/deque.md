...
5) Constructs the container with the contents of the range
   ...
   `deque(static_cast<size_type>(first), static_cast<value_type>(last), a)` if
...
previously published C++ standards.
  ...
  LWG 144 | C++98 | the complexity requirement of overload (5) was the same as
      that of the corresponding overload of `std::vector` | changed to linear
      complexity
  LWG 237 | C++98 | the complexity requirement of overload (5) was linear in
      `first - last` | changed to linear in `std::distance(first, last)`
...
---
*Source: https://en.cppreference.com/w/cpp/container/deque/deque*
