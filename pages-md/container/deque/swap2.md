...
void swap( std::deque<T, Alloc>& lhs,
           std::deque<T, Alloc>& rhs );  // (until C++17)
template< class T, class Alloc >
void swap( std::deque<T, Alloc>& lhs,
...
Specializes the `std::swap` algorithm for `std::deque`. Swaps the contents of
...
---
*Source: https://en.cppreference.com/w/cpp/container/deque/swap2*
