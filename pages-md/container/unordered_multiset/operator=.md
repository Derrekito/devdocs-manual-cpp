...
The following code uses `operator=` to assign one `std::unordered_multiset` to
another:
...
- **(constructor)** — constructs the `unordered_multiset` (public member
  function)

---
*Source: https://en.cppreference.com/w/cpp/container/unordered_multiset/operator%3D*
