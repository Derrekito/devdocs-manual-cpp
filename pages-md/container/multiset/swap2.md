...
void swap( std::multiset<Key, Compare, Alloc>& lhs,
           std::multiset<Key, Compare, Alloc>& rhs );  // (until C++17)
template< class Key, class Compare, class Alloc >
void swap( std::multiset<Key, Compare, Alloc>& lhs,
...
Specializes the `std::swap` algorithm for `std::multiset`. Swaps the contents of
...
---
*Source: https://en.cppreference.com/w/cpp/container/multiset/swap2*
