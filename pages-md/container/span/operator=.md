...
shallow copy of the data pointer and the size, i.e., after a call to this
function, `data() == other.data()` and `size() == other.size()`.
...
---
*Source: https://en.cppreference.com/w/cpp/container/span/operator%3D*
