...
```cpp
bitset& set();  // (until C++11)
bitset& set() noexcept;  // (since C++11) (constexpr since C++23)
...
- **pos** — the position (counting from `​0​`, i.e. from least significant to
  most significant) of the bit to set
