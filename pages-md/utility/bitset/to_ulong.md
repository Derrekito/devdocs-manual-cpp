...
The first bit of the bitset corresponds to the least significant digit of the
...
Throws `std::overflow_error` if the value can not be represented in `unsigned
long`.
