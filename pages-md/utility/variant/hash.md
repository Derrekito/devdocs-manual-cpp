...
Unlike `std::hash<std::optional>`, hash of a variant does not typically equal
the hash of the contained value; this makes it possible to distinguish
`std::variant<int, int>` holding the same value as different alternatives.
