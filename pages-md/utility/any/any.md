...
explicit any( std::in_place_type_t<ValueType>, Args&&... args );  // (5) (since C++17)
...
Because the default constructor is `constexpr`, static `std::any`s are
initialized as part of static non-local initialization, before any dynamic
non-local initialization begins. This makes it safe to use an object of type
`std::any` in a constructor of any static object.
