...
This page tries to list all the macro symbols that are available from the
...
`__cpp_lib_string_view` (since C++17)(updated in C++20)
...
---
*Source: https://en.cppreference.com/w/cpp/symbol_index/macro*
