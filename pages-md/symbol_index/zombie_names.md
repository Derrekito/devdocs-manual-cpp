...
This page tries to list all the symbols that were available from the Standard
Library in the namespace `std` or in the scope of a scoped enumeration or a
class, but removed in following standards. The symbols are written as follows:
...
previously published C++ standards.
  ...
  LWG 3885 | C++17 | “`op`” is not a reserved member name | it is

---
*Source: https://en.cppreference.com/w/cpp/symbol_index/zombie_names*
