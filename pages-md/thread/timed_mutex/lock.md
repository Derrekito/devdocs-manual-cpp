...
undefined: for example, the program *may* deadlock. An implementation that can
detect the invalid usage is encouraged to throw a `std::system_error` with error
...
---
*Source: https://en.cppreference.com/w/cpp/thread/timed_mutex/lock*
