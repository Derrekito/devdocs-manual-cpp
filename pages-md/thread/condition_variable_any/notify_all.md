...
to release the lock, though some implementations recognize the pattern and do
not attempt to wake up the thread that is notified under lock.
...
---
*Source: https://en.cppreference.com/w/cpp/thread/condition_variable_any/notify_all*
