...
The example visualizes a concurrent work of several randomized threads when no
more than N (N is the semaphore *desired* value) of the thread-functions are
active, while the other might wait on the semaphore.
...
---
*Source: https://en.cppreference.com/w/cpp/thread/counting_semaphore/acquire*
