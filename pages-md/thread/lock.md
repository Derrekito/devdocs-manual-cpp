...
and `unlock`. If a call to `lock` or `unlock` results in an exception, `unlock`
...
`std::scoped_lock` offers a RAII wrapper for this function, and is generally
preferred to a naked call to `std::lock`.
...
---
*Source: https://en.cppreference.com/w/cpp/thread/lock*
