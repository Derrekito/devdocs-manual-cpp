...
`true` if the `stop_token` object has associated stop-state and it received a
stop request, `false` otherwise.
...
---
*Source: https://en.cppreference.com/w/cpp/thread/stop_token/stop_requested*
