...
bool try_lock_for( const std::chrono::duration<Rep, Period>& timeout_duration );  // (since C++14)
```
...
---
*Source: https://en.cppreference.com/w/cpp/thread/shared_timed_mutex/try_lock_for*
