...
- **ETIME (C++11) (deprecated in C++23)** — Stream `ioctl()` timeout (macro
  constant)
...
`<errno.h>`, the majority of the macros defined by `<cerrno>` were adopted by
C++ from the POSIX standard, rather than the C standard library.
