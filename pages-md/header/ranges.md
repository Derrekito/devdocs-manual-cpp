...
Note: The following names are only for exposition, they are not part of the
interface.
...
previously published C++ standards.
  ...
  LWG 3914 | C++23 | the constraint of `std::ranges::enumerate_view` was
      incorrectly specified in the synopsis | corrected

---
*Source: https://en.cppreference.com/w/cpp/header/ranges*
