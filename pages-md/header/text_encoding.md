...
- **std::hash<std::text_encoding> (C++26)** — hash support for
  `std::text_encoding` (class template specialization)
...
---
*Source: https://en.cppreference.com/w/cpp/header/text_encoding*
