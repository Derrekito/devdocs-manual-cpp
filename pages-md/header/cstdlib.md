...
This header provides miscellaneous utilities. Symbols defined here are used by
...
- **EXIT_SUCCESSEXIT_FAILURE** — indicates program execution status (macro
  constant)
- **MB_CUR_MAX** — maximum number of bytes in a multibyte character with the
  current locale (macro constant)
...
---
*Source: https://en.cppreference.com/w/cpp/header/cstdlib*
