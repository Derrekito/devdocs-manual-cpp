...
classification and string collation, numeric, monetary, and date/time formatting
and parsing, and message retrieval. Locale settings control the behavior of
stream I/O, regular expression library, and other components of the C++ standard
library.
...
- **text_encoding (C++26)** — describes an interface for accessing the IANA
  Character Sets registry (class)
*(since C++26)*
