...
unspecified whether a subsequent call to `noop_coroutine` returns a previously
obtained coroutine handle, or a coroutine handle referring to a new coroutine
state of no-op coroutine.
...
Return values from different calls to `noop_coroutine` may and may not compare
equal.
...
---
*Source: https://en.cppreference.com/w/cpp/coroutine/noop_coroutine*
