...
to base class destructor being virtual). An object of type `std::num_put`, like
...
from `std::num_put` and implements a public destructor.
...
---
*Source: https://en.cppreference.com/w/cpp/locale/num_put/%7Enum_put*
