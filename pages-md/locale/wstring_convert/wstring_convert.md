...
2) Constructs the `wstring_convert` object with a specified conversion facet,
   using default-constructed values for the shift state and the error strings.

3) Constructs the `wstring_convert` object with a specified conversion facet and
   specified shift state, using default-constructed values for the error
   strings.

4) Constructs the `wstring_convert` object with specified error strings, using
   `new Codecvt` as the conversion facet and the default-constructed
