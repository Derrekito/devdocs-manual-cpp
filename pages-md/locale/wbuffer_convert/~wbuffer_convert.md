...
Destroys the `wbuffer_convert` object and deletes the pointer to the conversion
facet.
...
have a public destructor, similar to the locale-independent facets from
`<codecvt>`.
...
---
*Source: https://en.cppreference.com/w/cpp/locale/wbuffer_convert/%7Ewbuffer_convert*
