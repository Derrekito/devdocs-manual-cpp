...
Only the first character of the string returned is the character that appears in
the `pos_format()`/`neg_format()` position indicated by the value `sign`. The
rest of the characters appear *after* the rest of the monetary string.
...
The string of type `string_type` holding the characters to be used as positive
or negative sign.
...
---
*Source: https://en.cppreference.com/w/cpp/locale/moneypunct/positive_sign*
