...
void swap( std::basic_spanstream<CharT, Traits>& lhs,
           std::basic_spanstream<CharT, Traits>& rhs );  // (since C++23)
```

Overloads the `std::swap` algorithm for `std::basic_spanstream`. Exchanges the
...
---
*Source: https://en.cppreference.com/w/cpp/io/basic_spanstream/swap2*
