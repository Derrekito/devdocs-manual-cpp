...
std::hex` for any `out` of type `std::basic_ostream` or with an expression such
as `in >> std::hex` for any `in` of type `std::basic_istream`.
...
---
*Source: https://en.cppreference.com/w/cpp/io/manip/hex*
