...
1) The copy assignment operator is protected, and is deleted. Output streams are
   not CopyAssignable.
...
2) The move assignment operator exchanges all data members of the base class,
   ...
   operators of the derived movable output stream classes `std::basic_ofstream`
   and `std::basic_ostringstream`, which know how to correctly move-assign the
...
previously published C++ standards.
  ...
  LWG 2067 | C++11 | 1. the parameter type of overload (1) was `basic_ostream&`
      2. the parameter type of overload (2) was const basic_ostream&& | 1. added
      const 2. removed const

---
*Source: https://en.cppreference.com/w/cpp/io/basic_ostream/operator%3D*
