...
associated `std::strstreambuf`. Effectively calls `rdbuf()->pcount()`.
...
- **pcount** — returns the next pointer minus the beginning pointer in the
  output sequence: the number of characters written (public member function of
  `std::strstreambuf`)

---
*Source: https://en.cppreference.com/w/cpp/io/ostrstream/pcount*
