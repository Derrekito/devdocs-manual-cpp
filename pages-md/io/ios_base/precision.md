...
output performed by `std::num_put::do_put`.
...
previously published C++ standards.
  ...
  LWG 189 | C++98 | 'precision' was defined as 'the number of digits after the
      decimal point', but it is not correct in some cases | corrected
