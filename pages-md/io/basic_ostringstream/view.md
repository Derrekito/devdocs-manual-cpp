...
Obtains a `std::basic_string_view` over the underlying string object. Equivalent
to `return rdbuf()->view();`.
...
---
*Source: https://en.cppreference.com/w/cpp/io/basic_ostringstream/view*
