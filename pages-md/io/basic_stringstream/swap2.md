...
void swap( std::basic_stringstream<CharT,Traits,Alloc>& lhs,
           std::basic_stringstream<CharT,Traits,Alloc>& rhs );  // (since C++11)
```

Overloads the `std::swap` algorithm for `std::basic_stringstream`. Exchanges the
...
---
*Source: https://en.cppreference.com/w/cpp/io/basic_stringstream/swap2*
