...
void swap( std::basic_istringstream<CharT,Traits,Alloc>& lhs,
           std::basic_istringstream<CharT,Traits,Alloc>& rhs );  // (since C++11)
```

Overloads the `std::swap` algorithm for `std::basic_istringstream`. Exchanges
...
---
*Source: https://en.cppreference.com/w/cpp/io/basic_istringstream/swap2*
